/*
 * sgwsApnLevelLoadControlInformationInDeleteBearerRequest.cpp
 *
...
bool SgwsApnLevelLoadControlInformationInDeleteBearerRequest::
encodeSgwsApnLevelLoadControlInformationInDeleteBearerRequest(MsgBuffer &buffer,
...
bool SgwsApnLevelLoadControlInformationInDeleteBearerRequest::
decodeSgwsApnLevelLoadControlInformationInDeleteBearerRequest(MsgBuffer &buffer,
                         SgwsApnLevelLoadControlInformationInDeleteBearerRequestData 
                         &data, Uint16 length)
{
...
void SgwsApnLevelLoadControlInformationInDeleteBearerRequest::
displaySgwsApnLevelLoadControlInformationInDeleteBearerRequestData_v
(SgwsApnLevelLoadControlInformationInDeleteBearerRequestData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add("SgwsApnLevelLoadControlInformationInDeleteBearerRequest:");
    stream.endOfLine();
    stream.incrIndent();
